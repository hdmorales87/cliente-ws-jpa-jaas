 ...
 * generated in the org.hmorales.webapp.jaxws.services package. 
...
public class ObjectFactory {
    ...
    private final static QName _Guardar_QNAME = new QName("http://services.jaxws.webapp.hmorales.org/", "guardar");
    private final static QName _GuardarResponse_QNAME = new QName("http://services.jaxws.webapp.hmorales.org/", "guardarResponse");
    private final static QName _Listar_QNAME = new QName("http://services.jaxws.webapp.hmorales.org/", "listar");
    private final static QName _ListarResponse_QNAME = new QName("http://services.jaxws.webapp.hmorales.org/", "listarResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.hmorales.webapp.jaxws.services
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://services.jaxws.webapp.hmorales.org/", name = "guardar")
     ...
     */
    @XmlElementDecl(namespace = "http://services.jaxws.webapp.hmorales.org/", name = "guardarResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://services.jaxws.webapp.hmorales.org/", name = "listar")
     ...
     */
    @XmlElementDecl(namespace = "http://services.jaxws.webapp.hmorales.org/", name = "listarResponse")
