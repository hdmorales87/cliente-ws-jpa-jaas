 ...
 * 
 */
@WebService(name = "CursoServicioWs", targetNamespace = "http://services.jaxws.webapp.hmorales.org/")
@XmlSeeAlso({
    ObjectFactory.class
})
public interface CursoServicioWs {
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "guardar", targetNamespace = "http://services.jaxws.webapp.hmorales.org/", className = "org.hmorales.webapp.jaxws.services.Guardar")
    @ResponseWrapper(localName = "guardarResponse", targetNamespace = "http://services.jaxws.webapp.hmorales.org/", className = "org.hmorales.webapp.jaxws.services.GuardarResponse")
